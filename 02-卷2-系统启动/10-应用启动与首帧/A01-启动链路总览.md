...
|:-----|:------------|:-----|:----|
| 1 | `dumpsys activity processes` | 看进程优先级 + OomAdj | [D02 §3.3](../../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/02-Activity与AMS视角.md#33-dumpsys-activity-processes进程调度--oomadj-真相)) |
| 2 | `dumpsys activity services` | 看 Service 启动状态 | [D02 §3.5](../../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/02-Activity与AMS视角.md#35-dumpsys-activity-serviceservice-状态--service-anr-入口)) |
| 3 | `dumpsys window` | 看 Window 状态 + 焦点 | [D03 §3.1](../../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/03-Window与WMS视角.md#31-dumpsys-window无参数--wms-全量)) |
| 4 | `dumpsys dropbox` | 看崩溃 + 重启历史 | [D11 §3.1](../../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/11-稳定性监控集成.md#31-dumpsys-dropbox标签列表)) |
