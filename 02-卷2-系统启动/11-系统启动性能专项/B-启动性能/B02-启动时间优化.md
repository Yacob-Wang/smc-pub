...
- **本篇系列角色**：**B 模块 · 优化方法篇**（§8 破例：单篇 700+ 行 / 图表 5-7 张）
- **强依赖**：
  - [A01-启动链路总览](../../10-应用启动与首帧/A01-启动链路总览.md)（必读前置）
  - [A04-Zygote + SystemServer](../../10-应用启动与首帧/A04-Zygote+SystemServer.md)（Zygote 机制）
  - [A05-AMS/PMS/WMS 四大组件启动](../../10-应用启动与首帧/A05-AMS-PMS-WMS四大组件启动.md)（onCreate 优化）
  - [B01-Boot Time 测量](B01-BootTime测量.md)（B01 必读前置）
  - [ART 系列 · 02-dex2oat](../ART/02-dex2oat编译机制.md)（如有）
- **承接自**：[B01 §6.5 优化前/后对比](B01-BootTime测量.md)
- **衔接去**：
  - 下一篇 [B03-黑屏问题](B03-黑屏问题.md) 介绍黑屏专项
  - 然后 B04（启动卡顿）
- **不重复内容**：
...
> - [B01-Boot Time 测量](B01-BootTime测量.md) 已深入的测量方法
>
> **视角互补**：
...
> **系列导航**：
> - **上一篇**：[B01-Boot Time 测量](B01-BootTime测量.md)
> - **下一篇**：[B03-黑屏问题](B03-黑屏问题.md)
...
> - **工具联动**：[Dumpsys D11-dropbox](../../../05-卷5-调查工具链/33-Dumpsys%20·%20Bugreport%20·%20DropBox/11-稳定性监控集成.md) · [B01-Boot Time 测量](B01-BootTime测量.md)
