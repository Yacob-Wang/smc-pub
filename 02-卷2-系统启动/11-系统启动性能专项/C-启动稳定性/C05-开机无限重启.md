...
- **强依赖**：
  - [A02-Bootloader 到 Kernel](../../10-应用启动与首帧/A02-Bootloader到Kernel.md)（必读 · AVB 校验）
...
> - [A02-Bootloader 到 Kernel](../../10-应用启动与首帧/A02-Bootloader到Kernel.md) 已深入的 Bootloader + AVB
...
> - **机制联动**：[Stability S06-REBOOT 专题](../Stability/S06-重启与REBOOT专题.md) · [A02-Bootloader 到 Kernel](../../10-应用启动与首帧/A02-Bootloader到Kernel.md) · [C04-启动崩溃](C04-启动崩溃.md)
