...
- **强依赖**：
  ...
  - [Linux_Kernel/Process](../Linux_Kernel/Process/)
...
> - **机制联动**：[B01-Boot Time 测量](B01-BootTime测量_bootchart与perfetto-boot-trace.md) · [A02-Bootloader 到 Kernel](A02-Bootloader到Kernel.md) · [Linux_Kernel/Process](../Linux_Kernel/Process/)
