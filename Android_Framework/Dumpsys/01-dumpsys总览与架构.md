...
- **不重复内容**：
  ...
  - **不重复** [Stability S00-S07](../../Android_Framework/Stability/S00-稳定性症状总览.md) 的 7 大症状严格定义
...
| 2 | 硬伤 | 案例 A 用 AOSP issue tracker 真实 issue 编号 | v4 §4 #8 案例可验证性 | §6.1 |
...
> **本系列不重复现有系列已深入的机制**——D02/D03/D04/D08/D10 等会引用 [Process](../Process/)、[Window](../Window/)、[ART](../../Runtime/ART/03-GC系统/)、[Input](../Input/)、[Linux_Kernel/FS](../../Linux_Kernel/FS/) 等现有系列。
>
> **视角互补**：
