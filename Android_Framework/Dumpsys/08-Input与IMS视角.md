...
- **衔接去**：
  ...
  - 与 [Input 系列](../Input/) 8 篇 + [Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md) 联动
- **不重复内容**：
  - **不重复** [Input 系列](../Input/) 8 篇对 InputDispatcher / EventHub 的深挖
  - **不重复** [Linux_Kernel/Input_Driver](../../Linux_Kernel/Input_Driver/) 对内核 input 子系统的深挖
  - 本篇与之关系：**工具视角 ↔ 机制视角**
...
- **下一篇**：[D09-Network与Connectivity](09-Network与Connectivity.md)
- **机制联动**：[Input 系列](../Input/) 8 篇 · [Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md)
...
> - **下一篇**：[D09-Network与Connectivity](09-Network与Connectivity.md)
> - **本系列 README**：[README-Dumpsys系列.md](README-Dumpsys系列.md)
> - **机制联动**：[Input 系列](../Input/) · [Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md)
