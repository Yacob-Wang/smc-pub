...
- **衔接去**：
  ...
  - 与 [Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md) 联动（机制视角 ↔ 工具视角）
- **不重复内容**：
  - **不重复** [Activity 系列](../Activity/) 2 篇对 Activity 生命周期的深挖
  - **不重复** [Process 系列](../Process/) 8 篇对进程生命周期的深挖
  - **不重复** [Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md) 对 ANR 4 类的机制讲解
...
- **机制联动**：[Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md) · [Process 系列](../Process/)
...
> - [Stability S01-ANR](../../Android_Framework/Stability/S00-稳定性症状总览.md)：ANR 4 类的机制讲解
>
> **视角互补**：
