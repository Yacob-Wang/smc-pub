...
- **不重复内容**：
  ...
  - **不重复** [Stability S05-HANG](../../Android_Framework/Stability/S00-稳定性症状总览.md) 的全栈 HANG 决策树
...
| 2 | 硬伤 | 关键字段表 + 阈值表（黑屏/卡顿/焦点）| v4 §4 #5 反例 | §4 |
...
- **机制联动**：[Window 系列](../Window/) · [Stability S05-HANG](../../Android_Framework/Stability/S00-稳定性症状总览.md)
...
> - [Stability S05-HANG](../../Android_Framework/Stability/S00-稳定性症状总览.md)：HANG 全栈决策树
>
> **视角互补**：
