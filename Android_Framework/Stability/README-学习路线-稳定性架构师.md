...
| **App/Handler** | [06-Handler与ANR](../../App/Handler_MessageQueue_Looper/06-Handler与ANR.md) | App 侧主线程为什么会卡 |
...
| 优先级 | 文章 | 原因 |
|:------|:-----|:-----|
| **⭐ 必读** | [01-Handler消息机制总览](../../App/Handler_MessageQueue_Looper/01-Handler消息机制总览.md) | 主线程模型的"心脏" |
| **⭐ 必读** | [02-Looper与线程模型](../../App/Handler_MessageQueue_Looper/02-Looper与线程模型.md) | 线程消息循环 |
| **⭐ 必读** | [05-同步屏障与异步消息](../../App/Handler_MessageQueue_Looper/05-同步屏障与异步消息.md) | 同步屏障卡死的经典坑 |
| **⭐ 必读** | [06-Handler与ANR](../../App/Handler_MessageQueue_Looper/06-Handler与ANR.md) | ANR 的主线程根因 |
| **⭐ 必读** | [07-Handler稳定性风险全景](../../App/Handler_MessageQueue_Looper/07-Handler稳定性风险全景.md) | 11 类风险全梳理 |
| 选读 | [08-诊断工具与监控体系](../../App/Handler_MessageQueue_Looper/08-消息机制诊断工具与监控体系.md) | LooperPrinter 监控方案 |
| 加餐 | [HandlerThread泄露分析与防治](../../App/Handler_MessageQueue_Looper/HandlerThread泄露分析与防治.md) | 实战案例 |
| 加餐 | [LooperPrinter是否需要监控？](../../App/Handler_MessageQueue_Looper/LooperPrinter是否需要监控？.md) | 决策依据 |
...
| 优先级 | 文章 | 原因 |
|:------|:-----|:-----|
| **⭐ 必读** | [01-NativeCrash总览](../../Runtime/Native_Crash/01-NativeCrash总览.md) | debuggerd 入口 |
| **⭐ 必读** | [02-Linux信号机制](../../Runtime/Native_Crash/02-Linux信号机制.md) | 6 种致命信号根因 |
| **⭐ 必读** | [04-debuggerd与Tombstone](../../Runtime/Native_Crash/04-debuggerd与Tombstone.md) | tombstone 抓取链路 |
| **⭐ 必读** | [06-Tombstone深度解读](../../Runtime/Native_Crash/06-Tombstone深度解读.md) | 16 段结构怎么读 |
| **⭐ 必读** | [08-APM集成与治理](../../Runtime/Native_Crash/08-APM集成与治理.md) | 监控落地 |
| 选读 | [03-内存管理与保护](../../Runtime/Native_Crash/03-内存管理与保护.md) | 内存越界原理 |
| 选读 | [05-栈回溯与符号化](../../Runtime/Native_Crash/05-栈回溯与符号化.md) | unwinding |
| 选读 | [07-检测工具体系](../../Runtime/Native_Crash/07-检测工具体系.md) | asan / fuzzer / 内存检测 |
...
| 场景 | 必读 |
|:-----|:-----|
| **GC 问题 / OOM** | [03-GC系统/01-基础理论](../../Runtime/ART/03-GC系统/01-基础理论/) 全部 + [02-Heap与分配器](../../Runtime/ART/03-GC系统/02-Heap与分配器/) 全部 + [05-Generational-CC](../../Runtime/ART/03-GC系统/05-Generational-CC/) 全部 + [09-GC诊断与治理](../../Runtime/ART/03-GC系统/09-GC诊断与治理/) 全部 |
| **启动慢** | [07-启动流程](../../Runtime/ART/07-启动流程/) 全部 + [02-编译与执行](../../Runtime/ART/02-编译与执行/) 全部 |
| **JNI 崩溃** | [05-JNI](../../Runtime/ART/05-JNI/) 全部 + [01-字节码与指令集](../../Runtime/ART/01-字节码与指令集/) 全部 |
| **ANR 信号链路** | [06-信号与ANR-Trace](../../Runtime/ART/06-信号与ANR-Trace/) 全部 |
| **类加载 / NoClassDefFoundError** | [03-类加载与链接](../../Runtime/ART/03-类加载与链接/) 全部 |
...
| 场景 | 必读 |
|:-----|:-----|
| **Binder hang / 饿死** | [Linux_Kernel/Binder/05-线程模型](../../Linux_Kernel/Binder/05-Binder线程模型.md) + [07-稳定性风险全景](../../Linux_Kernel/Binder/07-Binder稳定性风险全景.md) + [10-oneway限流](../../Linux_Kernel/Binder/10-Binder-oneway限流与防护方案.md) |
| **IO hang / 存储卡顿** | [Linux_Kernel/IO/](../../Linux_Kernel/IO/) 全部 + [Linux_Kernel/FS/](../../Linux_Kernel/FS/) 全部 + [Linux_Kernel/DM/](../../Linux_Kernel/DM/) |
| **Kernel panic / oops** | [Linux_Kernel/Process/13-进程调试与稳定性关联](../../Linux_Kernel/Process/13-进程调试与稳定性关联.md) + [Linux_Kernel/Process/11-信号机制](../../Linux_Kernel/Process/11-信号机制_从产生到投递.md) |
| **内存 / OOM 链路** | [Linux_Kernel/Memory_Management/MM_v2/](../../Linux_Kernel/Memory_Management/MM_v2/) 全部 |
| **epoll 死锁 / socket hang** | [Linux_Kernel/epoll/](../../Linux_Kernel/epoll/) 全部 + [Linux_Kernel/socket/](../../Linux_Kernel/socket/) 全部 |
| **GKI 设备驱动** | [Linux_Kernel/GKI/](../../Linux_Kernel/GKI/) + [Linux_Kernel/Input_Driver/](../../Linux_Kernel/Input_Driver/) |
| **端侧 AI 对 ANR/性能影响** | [AI_Native_X/01-AI_Native_Runtime](../../AI_Native_X/01_AI_Native_Runtime/) + [03-AI_for_Stability](../../AI_Native_X/03_AI_for_Stability/) |
...
> - **机制入口**：[Process 系列](../Process/) · [Watchdog 系列](../Watchdog/) · [Handler 系列](../../App/Handler_MessageQueue_Looper/)
> - **工具入口**：[Perfetto](../Perfetto/) · [Hprof](../Hprof/) · [AmCommand](../AmCommand/)
> - **下层根因**：[Linux_Kernel/Binder](../../Linux_Kernel/Binder/) · [Linux_Kernel/Process](../../Linux_Kernel/Process/)
