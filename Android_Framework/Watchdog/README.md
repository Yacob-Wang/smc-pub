...
- `../../Linux_Kernel/socket/06-Unix_Domain_Socket与Android使用.md` - InputChannel 底层是 UDS socketpair
- `../../Linux_Kernel/IO/06-IO与进程的深度耦合：D状态、iowait、IO-hang、进程阻塞.md` - D 状态进入机制
