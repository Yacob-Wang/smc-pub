...
> - **基线**：`android-17.0.0_r1`（API 37） + `android17-6.18`（Linux 6.18 LTS，2025-11-30 发布，2025-12-03 确认 LTS）
...
> **基线说明（重要）**：AOSP 17 官方 build-numbers 实际默认内核为 6.12.58（2024-11-17 发布的 Linux 6.12 LTS），而 6.18 是 2025-11-30 发布的下一版 LTS。本系列按用户 2026-07-18 决策采用 6.18 作为基线——这意味着本篇覆盖 6.18 相对 6.12 的**5 大扩展**（详见 §1.4）：Rust Binder 成熟、sparse memory、sheaves 评估、eBPF 加密签名、pidfds 扩展。6.12 vs 6.18 差异用对比表/对照段显式标注，不混淆基线。
