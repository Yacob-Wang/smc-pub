...
> **承接 01 篇 §3 的"五层架构"**和进程系列 [03-Zygote-Android 进程工厂](../Android_Framework/Process/03-Zygote-Android进程工厂.md)的"印钞机"心智模型。
...
> **承接进程系列 [03-Zygote-Android 进程工厂](../Android_Framework/Process/03-Zygote-Android进程工厂.md) §10 的 5 大风险**。
...
- 进程系列 [03-Zygote-Android 进程工厂](../../../Android_Framework/Process/03-Zygote-Android进程工厂.md)——本篇 §2 Zygote 的"印钞机"心智模型
- 进程系列 [04-应用进程首生:从 fork 到 ActivityThread.main](../../../Android_Framework/Process/04-应用进程首生-fork到ActivityThread.md)——本篇 §3 App 进程 fork 后的"特化"路径
- 进程系列 [05-ART 进程内世界:JIT/AOT 与 GC](../../../Android_Framework/Process/05-ART进程内世界：JIT-AOT与GC.md)——本篇 §3.4 App Java 堆
- 进程系列 [06-Kernel 进程实现:task_struct 与 cgroup](../../../Android_Framework/Process/06-Kernel进程实现：task_struct与cgroup.md)——本篇 §6 Kernel 线程
- 分区系列 [`Linux_Kernel/Partition/`](../../../Linux_Kernel/Partition/)——zygote / system_server / app 加载的 `.so` 和 `.jar` 来自 `/system` / `/vendor` / `/data` 分区
