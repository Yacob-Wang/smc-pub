...
- 与 [Window 10-WMS 锁竞争](../../../../Android_Framework/Window/10-WMS锁竞争与Watchdog.md) 的关系：system_server 自身的 adj 是 -900，永不被杀——但它卡死时 Watchdog 会**主动重启 system_server**，与本篇 adj 体系不冲突
