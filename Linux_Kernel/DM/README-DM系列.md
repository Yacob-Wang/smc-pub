...
>
> **基线声明**（v4 规范硬要求 · 用户 2026-07-17 决策升级）：
...
> | 第 0 轮（立项） | 存量 | 保留 readme.md 旧版 10 篇规划标题；删除旧版中的"Linux 5.10"单一基线声明 | 升基线 + 与 v4 规范对齐 | 全部 10 篇 |
> | 第 0 轮（立项） | 存量 | 3 篇已有稿（开篇/架构/原理）需要按 v4 规范**重写**（mermaid → ASCII、补充源码+基线、补 4 附录） | 旧稿不满足 v4 §4 质量清单（#11-#16 附录、#22-#26 AI 生成质量） | 这 3 篇 |
...
| 10 排障 | Tools/Tracing | [20-Trace 抓取方法全面指南](../../../Tools/Tracing/20-Trace抓取方法全面指南.md) | ftrace bio/dm 事件捕获 |

---

## 3. 10 篇规划（v4 规范"第二步"产出）
...
| v2 | 2026-07-17 | 升基线 AOSP 17 + android17-6.18；按 v4 规范补"作者决策日志 / 跨系列引用矩阵 / 工程默认值表 / 校准计划" | 用户指令 + v4 规范升级 |
