...
- **主线程假死**：主线程在 epoll_wait 唤醒后做了同步 IO（详见 [Handler 系列](../../App/Handler_MessageQueue_Looper/README-Handler系列.md)）
...
- 理解 InputDispatcher 端到端：[Input 系列](../../Android_Framework/Input/)
- 理解主线程消息机制：[Handler 系列](../../App/Handler_MessageQueue_Looper/README-Handler系列.md)
...
| §7 InputDispatcher | Input | [Input 系列](../../Android_Framework/Input/) | 端到端 Input 事件链路 |
| §7 Looper | Handler | [Handler 系列](../../App/Handler_MessageQueue_Looper/README-Handler系列.md) | Java/Native Looper 关系 |
