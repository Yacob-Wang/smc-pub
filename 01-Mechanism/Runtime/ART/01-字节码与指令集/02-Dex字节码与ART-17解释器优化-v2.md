...
> **本规范硬变化覆盖**：Android 17 无锁 MessageQueue（API 37+）

**Android 17 主线程 MessageQueue 改成无锁架构**（§5 已讲）—— **与 ART 17 解释器协调**：
...
> **本规范硬变化覆盖**：static final 不可变（API 37+）
