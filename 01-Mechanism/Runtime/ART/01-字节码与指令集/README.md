...
| 章节 | 标题 | 行数目标 | 状态 |
| :--- | :--- | ---: | :---: |
| 01 | [Dex 文件与 Dalvik 指令集](../../../../03-卷3-核心机制/20-ART%20运行时/20.A-ART基础/01-Dex文件与Dalvik指令集.md) | ~700 | ✅ |
...
> **返回阅读**：[README-ART 系列](../../../../03-卷3-核心机制/20-ART%20运行时/README-ART系列.md) 包含全系列目录与阅读建议。