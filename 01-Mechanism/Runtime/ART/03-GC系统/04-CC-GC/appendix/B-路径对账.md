...
| 路径 | 关联 |
|:---|:---|
| [Linux_Kernel/DM/09-DM-调优-性能与pcache](../01-Mechanism/Kernel/DM/09-DM-调优-性能与pcache.md) | §3 详述 Linux 6.18 sheaves 对 ART Native 堆的影响 |
| [Linux_Kernel/MM/02-内存模型](../01-Mechanism/Kernel/MM/02-内存模型.md) | 详述 Linux 6.18 内存屏障原语 |
| [Linux_Kernel/FS/05-io_uring](../01-Mechanism/Kernel/FS/05-io_uring.md) | 详述 Linux 6.18 io_uring 增强对 heap dump 的影响 |
