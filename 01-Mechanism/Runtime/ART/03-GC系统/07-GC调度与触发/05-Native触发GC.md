...
4. **Linux 6.18 sheaves 内存分配器是 Native 侧的"基线优化"** —— 让 Native 堆内存占用降低 **15-20%**，从源头减少 kGcCauseForNativeAlloc 触发。详见 [Linux_Kernel/DM/09-DM-调优-性能与pcache](../01-Mechanism/Kernel/DM/09-DM-调优-性能与pcache.md) §3。
