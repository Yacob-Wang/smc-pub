...
| 4 附录 | 仅源码索引 | A/B/C/D 完整 + 增补 ART 17 源码 | §4.6 强制要求 |
...
**Linux 6.18 关联详见**：[Linux_Kernel/MM/06-内存规整](../01-Mechanism/Kernel/MM/06-内存规整.md) §3。
...
5. **★ Linux 6.18 madvise 优化是 Trim 效果的"加速器"** —— madvise(MADV_DONTNEED) 在 6.18 上效率提升 **10-15%**，让 Trim 效果立竿见影。详见 [Linux_Kernel/MM/06-内存规整](../01-Mechanism/Kernel/MM/06-内存规整.md) §3。
