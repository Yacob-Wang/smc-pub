...
- **2024 的答案**: cgroup 内核决策 + Framework 提供 adj——`kernel/cgroup/memcontrol.c` 触发 memcg OOM, Framework 提供 ProcessRecord 账本
...
- MGLRU 是 Linux 5.10 合并的(commit `ccd2a0d4`, 2020-11-25 提交, Yu Zhao)
...
**关键事实**:
- **2024-09-18** Android 15 VanillaIceCream (V, API 35) 发布, 内核基线 Linux 6.6.30
...
- **AOSP 17 正式版本**(计划 2025-11-30 发布, 但 2026 走 trunk stable 模型)正式包含 MemoryLimiter
...
| **memcg OOM** (`kernel/cgroup/memcontrol.c`) | Kernel | cgroup `memory.max` 越界 | 本 cgroup 内 oom_score 最高 | 100-500ms | AOSP 14+ 全面切换, 主流 |
...
| 9 | Android 15 (V) 发布日期 2024-09-18 | AOSP 官方 | ✅ | §3.8 |
...
| 30 | MGLRU 引入版本 Linux 5.10 (commit ccd2a0d4, 2020-11-25) | Linux kernel git + 07 篇 §4.1 校准 | ✅ | §3.6 |
