...
| 15 | LMKD kill_reasons 枚举数 | 9 个(NONE / PRESSURE_AFTER_KILL / NOT_RESPONDING / LOW_SWAP_AND_THRASHING / LOW_MEM_AND_SWAP / LOW_MEM_AND_THRASHING / DIRECT_RECL_AND_THRASHING / LOW_MEM_AND_SWAP_UTIL / LOW_FILECACHE_AFTER_THRASHING / LOW_MEM / KILL_REASON_COUNT) | system/memory/lmkd/statslog.h(基于 CSDN 引用 14 篇)|
