...
- **"VMA 耗尽"通常不是被特殊映射耗尽**——是匿名 / 文件映射累积太多
...
- ✅ #26 图表密度达标——4 张 ASCII art 核心图（§1.1 / §3.4 / §5.2 / §5.3）+ 4 张关键表格（§2.1 / §3.1 / §6.1 / §8.1），平均 2700 字/图
...
**完成时间**：2026-06-23
**字数 / 行数**：约 1.1 万字 / 800+ 行（含 AUTHOR_ONLY 元信息；剥离后约 750 行）
