...
>
> **写作规范**:遵循 `PROMPT-技术系列文章写作指南.md`(§3 一站式模板 + §10 读者视图规范)
...
## 更新记录
- **2026-07-21**：**系列全部完成**（6/6）—— CG-01 ~ CG-06 全部按 v5 指南落地
  - 详见各篇 commit：CG-01 (`668300f`) / CG-02 (`141e9be`) / CG-03 (`4fa1741`) / CG-04 (`b9403f7`) / CG-05 (`0d7a4d3`) / CG-06 (`28e4fe5`)
  - 系列总收口 commit（待提交）
- **2026-07-21**：README 统一基线声明从 AOSP 14 改为 AOSP 17 + android17-6.18
- **2026-07-20**：系列启动（CG-01 写完）
...
总字数：约 10.3 万字（实际落地）
  CG-01: 1.73 万字 / 1350 行
  CG-02: 2.70 万字 / 1970 行
  CG-03: 1.90 万字 / 1500 行
  CG-04: 1.70 万字 / 1355 行
  CG-05: 1.70 万字 / 1095 行
  CG-06: 1.60 万字 / 966 行
  合计：约 8236 行
总 commit：6 个（每篇 1 个）+ 1 个系列收口
目标读者：Android 稳定性 SE / 性能工程师 / Framework 工程师
...
| 篇 | 标题 | commit hash | 行数 / 字数 |
|---|---|---|---|
| CG-01 | cgroup 的诞生与历史演进 | `668300f` | 1350 / 1.73 万 |
| CG-02 | cgroup 核心抽象的设计意图 | `141e9be` | 1970 / 2.70 万 |
| CG-03 | 3 大资源维度统一抽象（系列核心篇） | `4fa1741` | 1500 / 1.90 万 |
| CG-04 | Android 17 cgroup 树与 libprocessgroup | `b9403f7` | 1355 / 1.70 万 |
| CG-05 | cgroup 与稳定性的核心关系 | `0d7a4d3` | 1095 / 1.70 万 |
| CG-06 | 可观测性全景与风险地图（系列收口） | `28e4fe5` | 966 / 1.60 万 |
| **合计** | **6 篇 + README** | **6 commit** | **8236 / 10.33 万** |
