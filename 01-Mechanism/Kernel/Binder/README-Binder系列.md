...
| 2026-07-18 阶段 6 | **破例登记**（v4 §9 准则）| 04 篇 ASCII 图 0 张 + 09 篇 ASCII 图 0 张 | 04 主要是 6.18 vs 6.12 对比（59 行表格，符合"演进型"破例）；09 是 debugfs 字段字典（87 行表格+字段表，符合"诊断工具型"破例）。v4 §9 准则允许"演进型放宽到 3 张图+1-2 张对比表"、"诊断工具型放宽到 3 张图"。**实际视觉化靠表格+字段表+代码块+量化数据完成** | 仅 04、09 两篇 | 否（v4 §9 允许的合法破例） |
...
| 2026-07-18 阶段 6 v2 | **04/09 破例撤回** | 04/09 篇 ASCII 图 0 张（已破例）→ **各补 1 张图** | 整改后 #3/#26 全部 13/13 通过，**破例登记撤回**（v4 §9 准则不再适用 04/09）| 仅 04、09 两篇 | 否（破例取消）|
