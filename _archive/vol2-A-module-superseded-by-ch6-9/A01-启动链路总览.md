...
- **本篇系列角色**：**总览篇 / 全局观**（§8 破例：单篇 1000+ 行 / 图表 6-8 张）
- **强依赖**：
  - [Process 系列 · 01-进程总览](../../03-卷3-核心机制/13-进程与生命周期/13.B-进程生命周期/01-进程总览：从点图标看app进程的诞生消亡与全栈抽象.md)
  - [Process 系列 · 02-AMS-冷启动判定](../../03-卷3-核心机制/13-进程与生命周期/13.B-进程生命周期/02-AMS-冷启动判定与进程启动链路.md)
...
|:-----|:------------|:-----|:----|
| 1 | `dumpsys activity processes` | 看进程优先级 + OomAdj | [D02 §3.3](../../../../05-卷5-调查工具链/33-Dumpsys · Bugreport · DropBox/02-Activity与AMS视角.md#33-dumpsys-activity-processes进程调度--oomadj-真相)) |
| 2 | `dumpsys activity services` | 看 Service 启动状态 | [D02 §3.5](../../../../05-卷5-调查工具链/33-Dumpsys · Bugreport · DropBox/02-Activity与AMS视角.md#35-dumpsys-activity-serviceservice-状态--service-anr-入口)) |
| 3 | `dumpsys window` | 看 Window 状态 + 焦点 | [D03 §3.1](../../../../05-卷5-调查工具链/33-Dumpsys · Bugreport · DropBox/03-Window与WMS视角.md#31-dumpsys-window无参数--wms-全量)) |
| 4 | `dumpsys dropbox` | 看崩溃 + 重启历史 | [D11 §3.1](../../../../05-卷5-调查工具链/33-Dumpsys · Bugreport · DropBox/11-稳定性监控集成.md#31-dumpsys-dropbox标签列表)) |
...
> - **机制联动**：[Stability S00-S10](../Stability/S00-稳定性症状总览.md) · [Process 系列](../../03-卷3-核心机制/13-进程与生命周期/README-进程架构演进系列.md) · [Window 系列](../../03-卷3-核心机制/19-显示与渲染/README-Window系列.md)
> - **工具联动**：[Dumpsys 系列](../../05-卷5-调查工具链/33-Dumpsys%20·%20Bugreport%20·%20DropBox/01-dumpsys总览与架构.md) · [Perfetto 系列](../../05-卷5-调查工具链/31-Perfetto%20全栈使用/01-Perfetto系统总览与架构设计.md)
