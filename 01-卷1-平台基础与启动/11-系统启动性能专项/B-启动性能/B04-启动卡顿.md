...
- **本篇系列角色**：**B 模块 · 启动卡顿专项篇**（§8 破例：单篇 700+ 行 / 图表 5-7 张）
- **强依赖**：
  - [A05-AMS/PMS/WMS 四大组件启动](../../10-应用启动与首帧/A05-AMS-PMS-WMS四大组件启动.md)（onCreate 详解 · 必读前置）
  - [A06-第一帧与 Choreographer](../../10-应用启动与首帧/A06-第一帧与Choreographer.md)（Choreographer 必读）
...
- **承接自**：[B03-黑屏问题](B03-黑屏问题.md)
- **衔接去**：
  - B 模块收口 → 进入 C 模块（启动稳定性 5 篇）
  - 风险排查跳转 [C01-启动 ANR](../C-启动稳定性/C01-启动ANR.md)（如已写）
- **不重复内容**：
...
> - [A06-第一帧与 Choreographer](../../10-应用启动与首帧/A06-第一帧与Choreographer.md) 已深入的 Choreographer
...
> **系列导航**：
> - **上一篇**：[B03-黑屏问题](B03-黑屏问题.md)
> - **B 模块收口**：[README-AOSP_Startup系列.md](../README.md)
> - **下一步（待写）**：C01-C05 启动稳定性
> - **机制联动**：[Stability S01-ANR 专题](../Stability/S01-ANR卡死与Input响应专题.md) · [A05-四大组件启动](../../10-应用启动与首帧/A05-AMS-PMS-WMS四大组件启动.md) · [A06-第一帧](../../10-应用启动与首帧/A06-第一帧与Choreographer.md)
> - **工具联动**：[Dumpsys D05-Graphics](../../../03-卷3-调查工具/33-Dumpsys%20·%20Bugreport%20·%20DropBox/05-Graphics与渲染.md) · [D04-启动期综合调试](../D-启动工具/D04-启动期dumpsys-systrace-traceview综合.md)（规划中）
