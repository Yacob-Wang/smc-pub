...
- **本篇系列角色**：**C 模块 · 开机无限重启专题**（§8 破例：单篇 600+ 行 / 图表 4-6 张）
- **强依赖**：
  - [第6章 Bootloader 到 Kernel](../../06-Bootloader%20到%20Kernel/index.md)（必读 · AVB 校验）
  - [C02-启动死锁](C02-启动死锁.md)
  - [C04-启动崩溃](C04-启动崩溃.md)
...
> - [第6章 Bootloader 到 Kernel](../../06-Bootloader%20到%20Kernel/index.md) 已深入的 Bootloader + AVB
> - [C04-启动崩溃](C04-启动崩溃.md) 已深入的启动崩溃
...
> **系列导航**：
> - **上一篇**：[C04-启动崩溃](C04-启动崩溃.md)
> - **C 模块收口**：[README-AOSP_Startup系列.md](../README.md)
> - **下一步（待写）**：D01-D04 启动调试工具
> - **机制联动**：[Stability S06-REBOOT 专题](../Stability/S06-重启与REBOOT专题.md) · [第6章 Bootloader 到 Kernel](../../06-Bootloader%20到%20Kernel/index.md) · [C04-启动崩溃](C04-启动崩溃.md)
