...
| 文档 | 编号 | 作用 | 何时读 |
|:-----|:----:|:-----|:-------|
| [**学习路线（稳定性架构师 L00）**](../00-Meta/学习路线-稳定性架构师.md) | L00 | 4 阶段 × 3 角色 × 阅读路径 | **开始学习前**先看这个 |
...
> **架构师防混淆口诀**（速记，详见 [Reference/术语表.md §1.1](../00-Meta/术语表.md)）：
> - **ANR 主动 / HANG 被动**
...
- [Reference/术语表.md](../00-Meta/术语表.md) — 全局术语表（含本系列 7 大症状定义）
...
> **系列导航**：[← 进程架构演进系列](../02-卷2-核心机制/13-进程与生命周期/README-进程架构演进系列.md) | [本系列 README 顶部](#)
>
