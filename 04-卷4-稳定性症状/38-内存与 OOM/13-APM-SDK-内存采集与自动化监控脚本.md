...
**关键事实**:**没有 APM,内存 P0 永远"再压一次"**——5 件套抓不全,30 分钟闭环跑不完(详见 [26.12 §1](file:///E:/smc-pub/04-卷4-稳定性症状/38-内存与 OOM/12-Oncall-应急响应-内存专项-P0-30分钟闭环.md))。
...
**上一篇**:[26.12 Oncall 应急响应-内存专项-P0 30 分钟闭环](file:///E:/smc-pub/04-卷4-稳定性症状/38-内存与 OOM/12-Oncall-应急响应-内存专项-P0-30分钟闭环.md)
**实战引用**:[26.20-26.23 真机调试实战系列](file:///E:/smc-pub/04-卷4-稳定性症状/38-内存与 OOM/)——APM 数据是实战系列的基础
