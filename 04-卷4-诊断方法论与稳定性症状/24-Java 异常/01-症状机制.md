...
- **本篇系列角色**：**症状专题 2/7**
- **强依赖**：必先读 [S00-稳定性症状总览](../22-稳定性调查方法论/S00-症状总览.md) §2.2 + [S01-ANR](../S01-ANR/01-症状机制.md) §2.1（ANR vs JE vs NE 边界）
- **承接自**：[S01-ANR](../S01-ANR/01-症状机制.md) 已覆盖主线程阻塞类症状；本篇覆盖**异常类**症状
- **衔接去**：
  - 下一篇 [S03-NE](../S03-NE/01-症状机制.md) 将深入 NE（**与 JE 的边界**：用户态 vs 内核态）
  - [S05-HANG](../S05-HANG/01-症状机制.md) 是 JE 的"沉默兄弟"（未抛异常但功能失效）
- **不重复内容**：
  - **不重复** [Runtime/ART/06-信号与ANR-Trace](../01-Mechanism/Runtime/ART/06-信号与ANR-Trace/) 对 ART 信号处理机制的深挖
...
- **上一篇**：[S01-ANR](../S01-ANR/01-症状机制.md) 已覆盖主线程阻塞类症状
- **下一篇**：[S03-NE](../S03-NE/01-症状机制.md) 将深入 NE（与 JE 的边界：用户态 vs 内核态）
...
**下一篇** [S03-NE](../S03-NE/01-症状机制.md) 将深入 NE（Native 崩溃）—— JE 的"内核态兄弟"：
...
> **系列导航**：[← S01-ANR](../S01-ANR/01-症状机制.md) | [本系列 README](../README.md) | [S03-NE →](../S03-NE/01-症状机制.md)
>
