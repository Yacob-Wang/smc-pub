...
- **不是**：不复述 [04 §2 三个数据源](04-AVC与avc_denied：从一次denied反推策略.md)；不复述 init 进程本身（[02-Symptom/S11-Startup/A03](../../../../../02-卷2-系统启动/A-启动机制/A03-Init进程与init.rc.md)）
...
| [02-Symptom/S11-Startup/A03-Init进程与init.rc](../../../../../02-卷2-系统启动/A-启动机制/A03-Init进程与init.rc.md) | init 进程本身的解析 |
