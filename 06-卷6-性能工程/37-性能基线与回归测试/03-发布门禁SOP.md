...
- 强依赖：[S10-01-症状机制](01-症状机制.md) / [S10-02-SLI与SLO设计](02-SLI与SLO设计：从指标到门禁.md) / [APM A03-6 大门禁维度](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A03-6大门禁维度.md) / [AmCommand/06-自动化实战](../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/06-自动化实战-脚本与CI集成.md)
- 衔接去：[A05-4 步闭环](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A05-4步闭环.md) §Step 2 决策
...
详见 [APM A03 §2 4 阶段门禁流程](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A03-6大门禁维度.md)。
...
| 模块 | 路径 | 关键 |
|:-----|:-----|:-----|
| 6 门禁 | [APM A03-6 大门禁维度](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A03-6大门禁维度.md) | 6 维度 |
| SLI/SLO | [S10-02-SLI与SLO设计](02-SLI与SLO设计：从指标到门禁.md) | 5 SLI |
| 4 步闭环 | [APM A05-4 步闭环](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A05-4步闭环.md) | 闭环 |
| 自动化 | [AmCommand/06-自动化实战](../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/06-自动化实战-脚本与CI集成.md) | CI 集成 |
| oncall | [OC01-oncall 工程总论](../../../05-卷5-调查方法论与工具链/36-Oncall 与应急响应/OC01-oncall工程总论：值班机制与工具栈.md) | 5/15/30 |
