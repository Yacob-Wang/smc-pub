...
>
> **本规范破例**：本文为**横切专题型**（§8 合法破例），单篇规模、图表密度、案例风格均放宽，**详见 §11 决策日志**

---

# 本篇定位

- **本篇系列角色**：**横切专题**（§8 合法破例）—— Stability 系列的"跨症状深挖"
- **强依赖**：必先读 [S00-稳定性症状总览](../../04-卷4-诊断方法论与稳定性症状/22-稳定性调查方法论/S00-症状总览.md) + [S01-S08 8 篇](.)
- **承接自**：
...
| 轮次 | 类别 | 决策 | 理由 | 影响范围 |
|:-----|:-----|:-----|:-----|:---------|
| 1 | 结构 | 单篇 1700+ 行（v4 默认 300 行） | §8 横切专题型破例：5 大专题各需 300 行深挖 | 仅本篇 |
| 1 | 结构 | 图表 5-7 张（v4 默认 4-6）| §8 横切专题型破例：5 大专题各 1 张时序图 + 总览 1-2 张 | 仅本篇 |
...
| 3 | 锐度 | 5 条 takeaway 含 2 条指向 S08 联动效应 | §4 必备 | §10 |
...
| 现有篇 | S09 与之关系 |
|:-------|:------------|
| [S00](../../04-卷4-诊断方法论与稳定性症状/22-稳定性调查方法论/S00-症状总览.md) | **强依赖**——S00 的 7 大症状分类法是 S09 映射表的基础 |
...
- [S00 总览](../../04-卷4-诊断方法论与稳定性症状/22-稳定性调查方法论/S00-症状总览.md) + [S01 ANR](../S01-ANR/01-症状机制.md) + [S02 JE](../S02-JE/01-症状机制.md) + [S03 NE](../S03-NE/01-症状机制.md) + [S04 SWT](../S04-SWT/01-症状机制.md) + [S05 HANG](../S05-HANG/01-症状机制.md) + [S06 REBOOT](../S06-REBOOT/01-症状机制.md) + [S07 KE](../S07-KE/01-症状机制.md) + [S08 演进全景](../S08-AOSP17-K618/01-症状机制.md) + **S09 5 大横向专题（本篇）**
...
> **系列导航**：[← S08 演进全景](../S08-AOSP17-K618/01-症状机制.md) | [本系列 README](../README.md) | [S00 总览 →](../../04-卷4-诊断方法论与稳定性症状/22-稳定性调查方法论/S00-症状总览.md)
>
