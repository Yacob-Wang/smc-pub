...
>
> **强依赖**：[06-Foundation/Tools/Android_Tools/02-Logcat格式](../../Tools/Android_Tools/02-Logcat格式与tag体系.md) · [01-Mechanism/Kernel/IO/11-eBPF在IO性能分析中的实战](../../../../03-卷3-核心机制/16-IO 与存储/11-eBPF在IO性能分析中的实战：从bpftrace到Android落地.md)
