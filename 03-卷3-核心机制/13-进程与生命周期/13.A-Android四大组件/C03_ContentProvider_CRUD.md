...
> 跨系列引用：见 [Service · bindService 跨进程通信](03_Service_BindService_Path.md)（bindService 跨进程通信对比）
...
> 跨系列引用：见 [Broadcast · 发送流程](B03_Broadcast_Send.md)（隐式广播 + 跨 App ContentProvider）
