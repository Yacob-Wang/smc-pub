...
- **强依赖**：
  - [A01-启动链路总览](../A-启动机制/A01-启动链路总览.md)（必读前置）
  - [A04-Zygote + SystemServer](../A-启动机制/A04-Zygote+SystemServer.md)（Zygote 机制）
  - [A05-AMS/PMS/WMS 四大组件启动](../A-启动机制/A05-AMS-PMS-WMS四大组件启动.md)（onCreate 优化）
...
> - **工具联动**：[Dumpsys D11-dropbox](../Dumpsys/11-稳定性监控集成.md) · [B01-Boot Time 测量](B01-BootTime测量.md)
