...
- **强依赖**：
  - [A05-AMS/PMS/WMS 四大组件启动](../A-启动机制/A05-AMS-PMS-WMS四大组件启动.md)（onCreate 详解 · 必读前置）
  - [A06-第一帧与 Choreographer](../A-启动机制/A06-第一帧与Choreographer.md)（Choreographer 必读）
...
> - [A06-第一帧与 Choreographer](../A-启动机制/A06-第一帧与Choreographer.md) 已深入的 Choreographer
...
> - **机制联动**：[Stability S01-ANR 专题](../Stability/S01-ANR卡死与Input响应专题.md) · [A05-四大组件启动](../A-启动机制/A05-AMS-PMS-WMS四大组件启动.md) · [A06-第一帧](../A-启动机制/A06-第一帧与Choreographer.md)
> - **工具联动**：[Dumpsys D05-Graphics](../Dumpsys/05-Graphics与渲染.md) · [D04-启动期综合调试](../D-启动工具/D04-启动期dumpsys-systrace-traceview综合.md)（规划中）
