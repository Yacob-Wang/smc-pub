...
> **评估基线**：v4 写作规范 + AOSP 17 + android17-6.18
...
- **强依赖**：[L00-学习路线](README-学习路线-稳定性架构师.md) + [S00-Stability 总览](S00-稳定性症状总览.md)
...
| 2 | 硬伤 | 35 个子系列 / ~310 篇全扫 | v4 §4 26 项清单 | 全部 |
...
- 评级标准：🟢 A 级（v4 规范）/ 🟡 B 级（v3 风格内容扎实）/ 🟠 C 级（必须重写）/ 🔴 D 级（空 / 事故）
...
> 简化版 v4 规范见 [PROMPT-v4.md](../../../PROMPT-技术系列文章写作指南-v4.md)。  
> **关键认知**：v4 关心的是"内容有/无"，不是"标题命名"——Service/Broadcast 用 `## 破例决策记录`（不是 `# 校准决策日志`）也属 v4 规范。
...
| 系列 | 路径 | 文章 | 备注 |
|:-----|:-----|:----:|:-----|
| Activity | `Android_Framework/Activity/` | 10 | v4 规范 |
...
| Service / Broadcast 评级从 🔴 D → 🟢 A | 实质内容符合 v4 规范 | Q00 报告 |
...
> - **学习路线**：[L00](README-学习路线-稳定性架构师.md)
> - **症状入口**：[S00](S00-稳定性症状总览.md)
