...
现有 12+ 个相关系列
  ...
  ├─ [Hprof 系列](../Hprof/)        ← F06
  ├─ [Native_Crash 系列](../../Runtime/Native_Crash/)  ← F04
  ├─ [Watchdog 系列](../Watchdog/)  ← F02
  ├─ [ANR_Detection 系列](../ANR_Detection/) ← F01
  ├─ [Linux_Kernel/FS](../../Linux_Kernel/FS/)  ← F05（pstore）
  ├─ [Tools/Tracing](../../Tools/Tracing/)  ← F06
  ├─ [Tools/Memory_Analysis](../../Tools/Memory_Analysis/)  ← F06
  ├─ [Android_Framework/Dumpsys](../Dumpsys/)  ← F07
  ├─ [Linux_Kernel/Process](../../Linux_Kernel/Process/)  ← F05
  └─ [App/Handler/Looper](../../App/Handler_MessageQueue_Looper/)  ← F01 / F06
```
...
| F01 | §5 解读 | [App/Handler/Looper](../../App/Handler_MessageQueue_Looper/) | README + 各篇 | 主线程 Looper 解读 |
...
| F02 | §5 喂狗链路 | [ART 06](../../Runtime/ART/06-信号与ANR-Trace/) | 全部 | ART 喂狗机制 |
...
| F03 | §4 异步线程 | [App/Handler/Looper](../../App/Handler_MessageQueue_Looper/) | README + 各篇 | 异步线程机制 |
| F03 | §5 OOM 相关 | [Hprof](../Hprof/) | README + 各篇 | OOM 抓取 |
| **F04 NE 取证** | §3 抓取链 | [Stability S03](../Stability/S03-NE.md) | §3 机制 | NE 触发机制 |
| F04 | §3 抓取链 | [Native_Crash](../../Runtime/Native_Crash/) | 8 篇全部 | debuggerd 源码 |
| F04 | §4 符号化 | [Native_Crash](../../Runtime/Native_Crash/) | 5-栈回溯与符号化 | 符号化服务 |
| F04 | §3.9 Rust Binder | [Linux_Kernel/Binder](../../Linux_Kernel/Binder/) | 全部 | Rust 版 Binder |
| F04 | §5 内存 NE | [Linux_Kernel/MM_v2](../../Linux_Kernel/Memory_Management/MM_v2/) | 12-内存稳定性风险全景 | 内存崩溃 |
| **F05 KE 取证** | §3 抓取链 | [Stability S07](../Stability/S07-KE.md) | §3 机制 | KE 触发机制 |
| F05 | §3 pstore | [Linux_Kernel/FS](../../Linux_Kernel/FS/) | pstore 相关 | pstore 机制 |
| F05 | §3 last_kmsg | [Linux_Kernel/FS](../../Linux_Kernel/FS/) | pstore 相关 | last_kmsg 机制 |
| F05 | §3 取证链路 | [Linux_Kernel/Process](../../Linux_Kernel/Process/) | 全部 | Kernel 进程机制 |
| F05 | §3 取证链路 | [Linux_Kernel/MM_v2](../../Linux_Kernel/Memory_Management/MM_v2/) | 全部 | 内存 BUG 触发 |
...
| F06 | §3 HANG 抓取 | [Tools/Tracing](../../Tools/Tracing/) | 全部 | ftrace 抓取 |
| F06 | §3 HANG 抓取 | [App/Handler/Looper](../../App/Handler_MessageQueue_Looper/) | README + 各篇 | 主线程机制 |
| F06 | §4 OOM 抓取 | [Stability S02](../Stability/S02-JE.md) | §3.5 OOM | OOM 触发机制 |
| F06 | §4 OOM 抓取 | [Hprof](../Hprof/) | 全部 | hprof 抓取与解读 |
| F06 | §4 OOM 抓取 | [Tools/Memory_Analysis](../../Tools/Memory_Analysis/) | 全部 | 内存分析工具 |
...
| F07 | §3 商业符号化 | [Native_Crash](../../Runtime/Native_Crash/) | 7-检测工具体系 | 商业符号化服务 |
| F07 | §3 bugreport | [Tools/Android_Tools](../../Tools/Android_Tools/) | 全部 | 抓取工具 |
...
| **NE 信号机制** | F04 只讲"信号触发后 tombstone 怎么生成 + 怎么符号化" | [Stability S03](../Stability/S03-NE.md) + [Native_Crash](../../Runtime/Native_Crash/) 8 篇讲透 |
...
| **KE 机制** | F05 只讲"KE 触发后怎么从 pstore / last_kmsg 取证" | [Stability S07](../Stability/S07-KE.md) + [Linux_Kernel/Process](../../Linux_Kernel/Process/) 讲透 |
...
| **bugreport 工具** | F07 只讲"稳定性场景的 bugreport 自动化" | [Tools/Android_Tools](../../Tools/Android_Tools/) 讲透工具 |
