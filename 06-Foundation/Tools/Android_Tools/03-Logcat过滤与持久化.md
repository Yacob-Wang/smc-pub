...
- **衔接去**：[04 Logcat 与 SELinux/avc](04-Logcat与SELinux-avc-denied行解读.md) / [06-Foundation/Tools/Tracing/20-Trace抓取方法全面指南](../Tracing/20-Trace抓取方法全面指南：ftrace-atrace-systrace-perfetto.md) / [04-Tool/AmCommand/05-诊断与监控-hang-monitor](../../../04-Tool/AmCommand/05-诊断与监控-hang-monitor.md)
...
| [03-Forensics/Bugreport/02 §4 logcat/ 详解](../../../03-Forensics/Bugreport/02-Bugreport-目录结构全梳理.md) | bugreport 中 logcat |
| [06-Foundation/Tools/Tracing/20-Trace抓取方法全面指南](../Tracing/20-Trace抓取方法全面指南：ftrace-atrace-systrace-perfetto.md) | trace 配合 logcat |
| [04-Tool/AmCommand/05-诊断与监控-hang-monitor](../../../04-Tool/AmCommand/05-诊断与监控-hang-monitor.md) | hang 监控 |
