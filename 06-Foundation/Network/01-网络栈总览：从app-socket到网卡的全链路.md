...
>
> **强依赖**：[06-Foundation/Tools/Android_Tools/02-Logcat格式](../../Tools/Android_Tools/02-Logcat格式与tag体系.md) · [01-Mechanism/Kernel/IO/11-eBPF在IO性能分析中的实战](../../../01-Mechanism/Kernel/IO/11-eBPF在IO性能分析中的实战：从bpftrace到Android落地.md)
...
# 3. 修法（见 [06-Foundation/SELinux/04](../../SELinux/04-AVC与avc_denied：从一次denied反推策略.md)）
```
...
| [01-Mechanism/Kernel/IO/11-eBPF](../../../01-Mechanism/Kernel/IO/11-eBPF在IO性能分析中的实战：从bpftrace到Android落地.md) | eBPF 工具 |
| [06-Foundation/SELinux/04-AVC与avc_denied](../../SELinux/04-AVC与avc_denied：从一次denied反推策略.md) | N05 修法 |
