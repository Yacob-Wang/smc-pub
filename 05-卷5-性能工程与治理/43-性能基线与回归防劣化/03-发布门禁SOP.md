...
- 强依赖：[S10-01-症状机制](01-症状机制.md) / [S10-02-SLI与SLO设计](02-SLI与SLO设计：从指标到门禁.md) / [APM A03-6 大门禁维度](../../../05-卷5-性能工程与治理/49-APM 架构与自研实践/A03-6大门禁维度.md) / [AmCommand/06-自动化实战](../../../03-卷3-调查工具/24-Dumpsys · Bugreport · DropBox/06-自动化实战-脚本与CI集成.md)
- 衔接去：[A05-4 步闭环](../../../05-卷5-性能工程与治理/49-APM 架构与自研实践/A05-4步闭环.md) §Step 2 决策
...
详见 [APM A03 §2 4 阶段门禁流程](../../../05-卷5-性能工程与治理/49-APM 架构与自研实践/A03-6大门禁维度.md)。
...
| 模块 | 路径 | 关键 |
|:-----|:-----|:-----|
| 6 门禁 | [APM A03-6 大门禁维度](../../../05-卷5-性能工程与治理/49-APM 架构与自研实践/A03-6大门禁维度.md) | 6 维度 |
| SLI/SLO | [S10-02-SLI与SLO设计](02-SLI与SLO设计：从指标到门禁.md) | 5 SLI |
| 4 步闭环 | [APM A05-4 步闭环](../../../05-卷5-性能工程与治理/49-APM 架构与自研实践/A05-4步闭环.md) | 闭环 |
| 自动化 | [AmCommand/06-自动化实战](../../../03-卷3-调查工具/24-Dumpsys · Bugreport · DropBox/06-自动化实战-脚本与CI集成.md) | CI 集成 |
| oncall | [OC01-oncall 工程总论](../../../03-卷3-调查工具/27-Oncall 与应急响应/OC01-oncall工程总论：值班机制与工具栈.md) | 5/15/30 |
