...
| **Linux 6.12 sheaves / io_uring 源码** | 未涉及 | **新增 A.19 整节** | 跨系列基线一致性 |
...
## A.19 【Linux 6.12 新增】sheaves / io_uring 源码

> **本节为 v2 升级新增**——列出 Linux 6.12 的核心新增源码（与 ART 17 配套）。

### A.19.1 sheaves 内存分配器

```
kernel/mm/
├── slab_common.c                            # 【Linux 6.12 新增】sheaves slab 实现
├── slab.h                                   # sheaves 数据结构
...
```
kernel/
├── io_uring.c                               # 【Linux 6.12 增强】io_uring 性能优化
...
## A.20 【AOSP 17 + Linux 6.12 关联】ART 内部状态 API
...
A.19：Linux 6.12 新增源码（sheaves + io_uring + smaps_rollup）
...
| 8 | sheaves Native 堆节省 | 15-20% | Linux 6.12 + AOSP 17 |
...
| Linux 6.12 源码 | `kernel/mm/` + `kernel/io_uring.c` | AOSP 17 配套 | 注意版本 | **基线纠正** |
