...
| Linux 6.12 sheaves 关联 | 未涉及 | **新增 §7.5 整节** | 跨系列基线一致性（Native 堆降低 15-20%） |
...
5. **Linux 6.12 sheaves 与 ART 17 GenCC 强化协同**——**Native 堆 -15-20% + CPU 占用 -5-15%**。ART 17 + Linux 6.12 是 2026 年 Android 性能的"基线组合"。
...
| 8 | Linux 6.12 `kernel/mm/slub.c`（关联） | ✅ 已校对 | 跨系列基线 |
