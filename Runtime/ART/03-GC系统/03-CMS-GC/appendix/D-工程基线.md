...
**衔接去**：[10-ART17分代GC强化专章 v2](../../10-ART17分代GC强化专章-v2.md) ART 17 硬变化；[Linux_Kernel/DM/09-DM-调优-性能与pcache](../../../Linux_Kernel/DM/09-DM-调优-性能与pcache.md) Linux 6.12 调优。
...
| **Native 堆（Linux 6.12）** | < 50MB | 50-70MB | 70-90MB | > 90MB | **-15-20%（sheaves）** |
...
| **Native 堆使用率** | < 60% | 60-80% | 80-90% | > 90% | **< 50%（Linux 6.12）** |
...
| 8 | Native 堆（Linux 6.12） | 80MB | **64MB（-15-20%）** |
| 9 | **软阈值** | **—** | **30%（AOSP 17 新增）** |
