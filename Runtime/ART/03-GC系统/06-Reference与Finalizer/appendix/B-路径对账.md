...
| 跨系列引用 | 目标文件 | 关联 |
|:---|:---|:---|
| Native 堆内存 | [Linux_Kernel/DM/09-DM-调优-性能与pcache](../../../Linux_Kernel/DM/09-DM-调优-性能与pcache.md) | §3 sheaves |
| I/O 性能 | [Linux_Kernel/DM/09-DM-调优-性能与pcache](../../../Linux_Kernel/DM/09-DM-调优-性能与pcache.md) | §3 io_uring |
...
| 来源 | 目标 | 关联 |
|:---|:---|:---|
| Reference 与 Finalizer | [Linux_Kernel/DM/09-DM-调优-性能与pcache](../../../Linux_Kernel/DM/09-DM-调优-性能与pcache.md) | Native 堆 + I/O 性能 |
