...
| **CASE-STAB-10-01** | **S10 度量门禁** | **某电商 App 6 月治理闭环：Stability Score 0.32 → 0.78** | **【典型模式】** | 2026-07-18 完成 |
| **CASE-STAB-10-02** | **S10 度量门禁** | **某社交 App 春节活动跳过门禁 → 损失 2000 万** | **【公开 bugreport 模式】** | 2026-07-18 完成 |
...
```markdown
> **案例引用**：本案例与 [Linux_Kernel/Binder](../01-Mechanism/Kernel/Binder/) 系列
> [binder 死锁案例 CASE-BINDER-03](../01-Mechanism/Kernel/Binder/CASE-BINDER-03.md) 同源，
