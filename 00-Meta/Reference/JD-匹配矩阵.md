...
| **D9 性能 / 启动** | **高** | P1 | [S11-Startup/](../../../02-卷2-系统启动/) → [Startup 案例](../../06-Case/Startup/) → [ART/07-启动流程/](../../01-Mechanism/Runtime/ART/07-启动流程/) → [Perfetto/](../../04-Tool/Perfetto/) | 性能岗可主读此线 |
...
| 行业 SLO 对标 | **缺失** | 等 `Industry-Benchmark/`；临时用 [S10-02](../../../06-卷6-性能工程/37-性能基线与回归测试/02-SLI与SLO设计：从指标到门禁.md) |
