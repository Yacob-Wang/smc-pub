...
- 强依赖：[S10-02-SLI与SLO设计](../../06-卷6-性能工程/37-性能基线与回归防劣化/02-SLI与SLO设计：从指标到门禁.md) / [A05-4 步闭环](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A05-4步闭环.md) / [A04-Stability Score](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A04-StabilityScore综合指数.md)
...
Android 5 大 SLI（详见 [S10-02-SLI与SLO设计](../../06-卷6-性能工程/37-性能基线与回归防劣化/02-SLI与SLO设计：从指标到门禁.md)）：
1. 启动成功率
2. Java 崩溃率
3. Native 崩溃率
4. ANR 率
...
P0（必自动化）：
  ...
  - 4 阶段门禁（[A03 6 大门禁](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A03-6大门禁维度.md)）
  - 自动回滚（[S10-03 §4.3](../../06-卷6-性能工程/37-性能基线与回归防劣化/03-发布门禁SOP.md)）
...
|:---------|:------------|:-----|
| **SLI** | 5 大 SLI | [S10-02 §2](../../06-卷6-性能工程/37-性能基线与回归防劣化/02-SLI与SLO设计：从指标到门禁.md) |
| **SLO** | SLO 阶梯 | [S10-02 §3](../../06-卷6-性能工程/37-性能基线与回归防劣化/02-SLI与SLO设计：从指标到门禁.md) |
| **Error Budget** | 月度预算监控 | [S10-02 §4](../../06-卷6-性能工程/37-性能基线与回归防劣化/02-SLI与SLO设计：从指标到门禁.md) |
| **4 步闭环** | 度量/决策/行动/回归 | [A05-4 步闭环](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A05-4步闭环.md) |
| **Stability Score** | 综合分 | [A04-Stability Score](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A04-StabilityScore综合指数.md) |
| **Toil 自动化** | CI/CD + 自动化测试 | [S10-03 发布门禁 SOP](../../06-卷6-性能工程/37-性能基线与回归防劣化/03-发布门禁SOP.md) |
...
| 模块 | 路径 | 关键 |
|:-----|:-----|:-----|
| SLI/SLO | [S10-02-SLI与SLO设计](../../06-卷6-性能工程/37-性能基线与回归防劣化/02-SLI与SLO设计：从指标到门禁.md) | 5 SLI |
| 4 步闭环 | [A05-4 步闭环](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A05-4步闭环.md) | 闭环 |
| Stability Score | [A04-Stability Score](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A04-StabilityScore综合指数.md) | 6 维 |
| 门禁 | [A03-6 大门禁维度](../../../07-卷7-APM与工程治理/43-APM 架构与自研实践/A03-6大门禁维度.md) | 6 维度 |
