...
- **本篇系列角色**：**E 模块 · 实战案例 2**（§8 破例：单篇 800+ 行 / 图表 5-7 张）
- **强依赖**：
  - [A04-Zygote + SystemServer](../../01-卷1-平台基础与启动/09-SystemServer%20启动/index.md)
  - [C02-启动死锁](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C02-启动死锁.md)
  - [C04-启动崩溃](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C04-启动崩溃.md)
  - [C05-开机无限重启](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C05-开机无限重启.md)
...
| 轮次 | 类别 | 决策 | 理由 | 影响范围 |
|:-----|:-----|:-----|:-----|:---------|
| 1 | 结构 | 单篇 800+ 行（§8 破例）| §9 实战案例破例 | 仅本篇 |
...
> **本篇不重复**：
> - [A04-Zygote + SystemServer](../../01-卷1-平台基础与启动/09-SystemServer%20启动/index.md) 已深入的 SystemServer 启动
> - [C02-启动死锁](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C02-启动死锁.md) 已深入的启动死锁
> - [C04-启动崩溃](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C04-启动崩溃.md) 已深入的启动崩溃
> - [C05-开机无限重启](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C05-开机无限重启.md) 已深入的 BootLoop
...
> - **下一篇**：[E03-案例 3：开机黑屏 30s SurfaceFlinger 卡死](E03-案例3_开机黑屏30s-SurfaceFlinger卡死.md)
> - **本系列 README**：[README-AOSP_Startup系列.md](../../01-卷1-平台基础与启动/README.md)
> - **机制联动**：[C02-启动死锁](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C02-启动死锁.md) · [C04-启动崩溃](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C04-启动崩溃.md) · [C05-开机无限重启](../../01-卷1-平台基础与启动/11-系统启动性能专项/C-启动稳定性/C05-开机无限重启.md)
> - **工具联动**：[Dumpsys D11-dropbox](../../03-卷3-调查工具/33-Dumpsys%20·%20Bugreport%20·%20DropBox/11-稳定性监控集成.md) · [D01-Perfetto Boot Trace](../../01-卷1-平台基础与启动/11-系统启动性能专项/D-启动工具/D01-Perfetto-Boot-Trace抓全栈启动时序.md)
