...
>
> **承接自**：[02-Symptom/S11-Startup/](../../02-卷2-系统启动/index.md)（AOSP_Startup 22 篇 v4）
>
> **完成日期**：2026-07-19
...
| 篇 | 案例主题 | 涉及模块 | 强依赖 | 状态 |
|:--|:---------|:---------|:-------|:----:|
| E01 | 冷启动 8s → 1s 优化全过程 | A + B + D | [B02 启动时间优化](../../02-卷2-系统启动/11-系统启动性能专项/B-启动性能/B02-启动时间优化.md) | ✅ |
| E02 | 启动卡死 SystemServer 60% 进度 | A + C + D | [C02 启动死锁](../../02-卷2-系统启动/11-系统启动性能专项/C-启动稳定性/C02-启动死锁.md) | ✅ |
| E03 | 开机黑屏 30s SurfaceFlinger 卡死 | A + C + D | [C03 启动黑屏](../../02-卷2-系统启动/11-系统启动性能专项/C-启动稳定性/C03-启动黑屏.md) | ✅ |
...
| 篇 | 案例主题 | 强依赖 |
|:--|:---------|:-------|
| E04 | 启动期 ANR：5s vs 20s vs 200s 阈值案例 | [C01 启动 ANR](../../02-卷2-系统启动/11-系统启动性能专项/C-启动稳定性/C01-启动ANR.md) |
