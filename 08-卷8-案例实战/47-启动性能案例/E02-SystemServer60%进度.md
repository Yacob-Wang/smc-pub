...
- **强依赖**：
  - [A04-Zygote + SystemServer](../../../02-卷2-系统启动/A-启动机制/A04-Zygote+SystemServer.md)
  - [C02-启动死锁](../../../02-卷2-系统启动/C-启动稳定性/C02-启动死锁.md)
  - [C04-启动崩溃](../../../02-卷2-系统启动/C-启动稳定性/C04-启动崩溃.md)
  - [C05-开机无限重启](../../../02-卷2-系统启动/C-启动稳定性/C05-开机无限重启.md)
...
> **本篇不重复**：
> - [A04-Zygote + SystemServer](../../../02-卷2-系统启动/A-启动机制/A04-Zygote+SystemServer.md) 已深入的 SystemServer 启动
> - [C02-启动死锁](../../../02-卷2-系统启动/C-启动稳定性/C02-启动死锁.md) 已深入的启动死锁
> - [C04-启动崩溃](../../../02-卷2-系统启动/C-启动稳定性/C04-启动崩溃.md) 已深入的启动崩溃
> - [C05-开机无限重启](../../../02-卷2-系统启动/C-启动稳定性/C05-开机无限重启.md) 已深入的 BootLoop
...
> - **机制联动**：[C02-启动死锁](../../../02-卷2-系统启动/C-启动稳定性/C02-启动死锁.md) · [C04-启动崩溃](../../../02-卷2-系统启动/C-启动稳定性/C04-启动崩溃.md) · [C05-开机无限重启](../../../02-卷2-系统启动/C-启动稳定性/C05-开机无限重启.md)
> - **工具联动**：[Dumpsys D11-dropbox](../Dumpsys/11-稳定性监控集成.md) · [D01-Perfetto Boot Trace](../../../02-卷2-系统启动/D-启动工具/D01-Perfetto-Boot-Trace抓全栈启动时序.md)
