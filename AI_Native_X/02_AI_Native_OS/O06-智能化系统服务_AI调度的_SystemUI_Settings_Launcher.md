...
| AI 化后的功耗治理（Thermal Aware） | ✓ 完整方案 + 风险 | 详见 [Linux_Kernel/Power_Management PM08](../Linux_Kernel/Power_Management/) |
...
**衔接去**：本篇是 **AI_Native_OS 子系列的收尾篇**，收口后转 [AI_for_Stability](../../AI_Native_X/03_AI_for_Stability/) 子系列（F01-F06），把 AI 能力**反哺稳定性治理**。
...
**跨系列引用**：
- AI Agent 跨 App 调度：[O04-AI Agent OS](O04-AI_Agent_OS_操作系统级的AI_Agent框架.md)
- 启动期优化：[Runtime/ART M8 启动流程](../../Runtime/ART/M8-启动流程.md)
- Thermal Aware：[Linux_Kernel/Power_Management PM08](../Linux_Kernel/Power_Management/)
- Window 渲染：[Android_Framework/Window](../../Android_Framework/Window/)
...
**详见**：[Linux_Kernel/Power_Management PM08-Thermal Aware 调度](../Linux_Kernel/Power_Management/PM08-Thermal_Aware调度.md)
...
| §5 启动期 AI 化 | Runtime/ART | [M8 启动流程](../../Runtime/ART/M8-启动流程.md) | 启动期 AI 化与 Zygote fork 联动 |
| §6 功耗治理 | Linux_Kernel/Power | [PM08 Thermal Aware](../Linux_Kernel/Power_Management/PM08-Thermal_Aware调度.md) | Thermal Aware 调度基础 |
| §6 锁屏冻结 | Linux_Kernel/Power | [PM06 Suspend/Resume](../Linux_Kernel/Power_Management/PM06-Suspend_Resume.md) | cgroup v2 freezer 与 Suspend 联动 |
...
| 全部 | Android_Framework | [Window 系列](../../Android_Framework/Window/) / [PKMS](../../Android_Framework/PKMS/) | SystemUI 渲染 + Settings 包管理 |
...
> **子系列完成 🎉**：AI_Native_OS 6 篇已全部完成。下一步可进入 [AI_for_Stability](../../AI_Native_X/03_AI_for_Stability/) 子系列（F01-F06），把 AI 能力**反哺稳定性治理**——AI for ANR 预测、AI 归因、智能 APM 等。