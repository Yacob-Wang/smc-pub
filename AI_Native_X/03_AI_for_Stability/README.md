...
| 2 | **F02** | 时序异常检测：Perfetto / bugreport / dropbox 的 AI 监控 | **核心机制 1/3** | F01 + [Tools/Perfetto](../../Tools/) | ~700 |
| 3 | **F03** | 智能归因：LLM 解析 crash/ANR 日志，自动聚类根因 | **核心机制 2/3** | F01 + [Runtime/Java_Crash](../../Runtime/Java_Crash/) + [Runtime/Native_Crash](../../Runtime/Native_Crash/) | ~700 |
| 4 | **F04** | AI 预测 ANR：基于主线程 Trace 的早期预警 | **核心机制 3/3** | F02 + [Android_Framework/Watchdog](../../Android_Framework/Watchdog/) + [App/Handler](../../App/) | ~700 |
| 5 | **F05** | 大模型日志分析：用 LLM 解读 native tombstone | **横切专题 1/2** | F03 + [Runtime/Native_Crash](../../Runtime/Native_Crash/) + [AI_Native_Runtime R08](../../AI_Native_X/01_AI_Native_Runtime/) | ~700 |
...
| 本篇章节 | 引用系列 | 引用文章 | 引用原因 |
| :--- | :--- | :--- | :--- |
| F01 §1 | AI_Native_Runtime | [R08 端侧 LLM](../../AI_Native_X/01_AI_Native_Runtime/) | LLM 是 F 系列的核心引擎 |
| F01 §1 | AI_Native_OS | [O05 端侧 LLM 系统集成](../../AI_Native_X/02_AI_Native_OS/) | 端侧推理能力基础 |
| F02 §6 | Tools | [Tools/Perfetto](../../Tools/) | Perfetto 数据采集 |
...
| F03 §4 | AI_Native_Runtime | [R08 端侧 LLM](../../AI_Native_X/01_AI_Native_Runtime/) | LLM 调用与 Function Calling |
...
| F05 §3 | AI_Native_Runtime | [R08 端侧 LLM](../../AI_Native_X/01_AI_Native_Runtime/) | LLM 推理基础 |
| F06 §3 | AI_Native_Runtime | [R08 端侧 LLM](../../AI_Native_X/01_AI_Native_Runtime/) | LLM 引擎集成 |
| F06 §4 | AI_Native_Runtime | [R02 AI HAL](../../AI_Native_X/01_AI_Native_Runtime/) | 端侧 AI HAL |
...
| :--- | :--- |
| **ART M6 信号与异常** | AI 解读 SIGSEGV / SIGBUS / SIGABRT（[F05](../../AI_Native_X/03_AI_for_Stability/)） |
| **ART M2 类加载** | AI 识别 ClassLoader.loadClass 阻塞（[F02](../../AI_Native_X/03_AI_for_Stability/)） |
| **ART M5 JNI** | AI 识别 JNI 慢调用（[F02](../../AI_Native_X/03_AI_for_Stability/)） |
| **ART M4 内存 GC** | AI 预测 OOM + 内存异常检测（[F02](../../AI_Native_X/03_AI_for_Stability/)） |
| **Watchdog** | AI 增强 HandlerChecker（[F04](../../AI_Native_X/03_AI_for_Stability/)） |
| **Tools/Tracing** | Perfetto 数据喂给 AI 模型（[F02](../../AI_Native_X/03_AI_for_Stability/)） |
| **Runtime/Native_Crash** | LLM 解读 Tombstone（[F05](../../AI_Native_X/03_AI_for_Stability/)） |
| **Runtime/Java_Crash** | LLM 解读 Java Exception（[F03](../../AI_Native_X/03_AI_for_Stability/)） |
| **App/Handler** | AI 分析主线程消息队列（[F04](../../AI_Native_X/03_AI_for_Stability/)） |
...
- 端侧 AI 框架：[MediaPipe](../../AI_Native_X/01_AI_Native_Runtime/) / ML Kit
- 端侧 LLM：[Gemini Nano](../../AI_Native_X/02_AI_Native_OS/O05-端侧大模型系统集成_Gemini_Nano_端侧LLM_SDK.md)
