...
- [Android_Framework/ANR_Detection](../../Android_Framework/ANR_Detection/)（ANR 触发机制）
- [Android_Framework/Watchdog](../../Android_Framework/Watchdog/)（HandlerChecker / AMS ANR）
- [App/Handler](../../App/Handler_MessageQueue_Looper/)（主线程 Message 队列）

**跨系列引用**：
- ART 主线程：[Runtime/ART/M2-类加载](../../Runtime/ART/)、[Runtime/ART/M5-JNI](../../Runtime/ART/)
