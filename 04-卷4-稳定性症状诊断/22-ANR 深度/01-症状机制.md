...
- **强依赖**：
  - 必先读 [S00-稳定性症状总览](../S00-症状总览.md) §2.2 七大症状横向对比表 + §2.3 cascade 触发链
- **承接自**：[S00-稳定性症状总览](../S00-症状总览.md) 已覆盖 ANR 在 7 大症状中的位置和触发条件，本篇**不再重复**这些
- **衔接去**：
...
- **上一篇**：[S00-稳定性症状总览](../S00-症状总览.md) 已覆盖 7 大症状的边界和系统栈映射
...
> **系列导航**：[← S00 总览](../S00-症状总览.md) | [本系列 README](../README.md) | [S05-HANG →](../S05-HANG/01-症状机制.md)
>
