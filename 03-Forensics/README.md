...
| [Native_Crash 系列](../01-Mechanism/Runtime/Native_Crash/) | 引用（机制） | Forensics F04 引用 NE 机制 |
| [Watchdog 系列](../Watchdog/) | 引用（机制） | Forensics F02 引用 SWT 机制 |
| [ANR_Detection 系列](../ANR_Detection/) | 引用（机制） | Forensics F01 引用 ANR 机制 |
| [Linux_Kernel/FS](../01-Mechanism/Kernel/FS/) | 引用（pstore） | Forensics F05 引用 pstore 机制 |
| [Tools/Tracing](../06-Foundation/Tools/Tracing/) | 引用（工具） | Forensics F06 引用 ftrace |
| [Tools/Memory_Analysis](../06-Foundation/Tools/Memory_Analysis/) | 引用（工具） | Forensics F06 引用内存分析 |
| [Android_Framework/Dumpsys](../Dumpsys/) | 引用（工具） | Forensics F07 引用 dumpsys |
| [App/Handler/Looper](../01-Mechanism/App/Handler-MessageQueue-Looper/) | 引用（机制） | Forensics F01/F06 引用主线程 Looper |
...
| F01 | [Stability S01](../Stability/S01-ANR.md) + [Perfetto](../Perfetto/) + [Handler/Looper](../01-Mechanism/App/Handler-MessageQueue-Looper/) | 3 |
| F02 | [Stability S04](../Stability/S04-SWT.md) + [Watchdog](../Watchdog/) + [Perfetto](../Perfetto/) | 3 |
| F03 | [Stability S02](../Stability/S02-JE.md) + [ANR_Detection](../ANR_Detection/) + [Handler/Looper](../01-Mechanism/App/Handler-MessageQueue-Looper/) | 3 |
| F04 | [Stability S03](../Stability/S03-NE.md) + [Native_Crash](../01-Mechanism/Runtime/Native_Crash/) + [Linux_Kernel/Binder](../01-Mechanism/Kernel/Binder/) | 3 |
| F05 | [Stability S07](../Stability/S07-KE.md) + [Linux_Kernel/FS](../01-Mechanism/Kernel/FS/) + [Linux_Kernel/Process](../01-Mechanism/Kernel/Process/) | 3 |
| F06 | [Stability S05](../Stability/S05-HANG.md) + [Perfetto](../Perfetto/) + [Hprof](../Hprof/) + [Tools/Tracing](../06-Foundation/Tools/Tracing/) | 4 |
| F07 | [Perfetto](../Perfetto/) + [Dumpsys](../Dumpsys/) + [Tools/Android_Tools](../06-Foundation/Tools/Android_Tools/) | 3 |
...
| §2 边界 | Forensics vs [Stability S03](../Stability/S03-NE.md) + [Native_Crash](../01-Mechanism/Runtime/Native_Crash/) |
...
| §2 边界 | Forensics vs [Perfetto](../Perfetto/) + [Dumpsys](../Dumpsys/) + [Tools/Android_Tools](../06-Foundation/Tools/Android_Tools/) |
...
| **附录 C 改名** | Forensics 系列把 §4 #15 量化自检表 + #16 工程基线表合并为"附录 D 工程基线表" | 取证链路视角下量化数据不多，合并避免冗余 | 全系列 8 篇 | 是（本系列基线）|
...
- [Tools/Tracing](../06-Foundation/Tools/Tracing/) — Tracing 工具
- [Tools/Memory_Analysis](../06-Foundation/Tools/Memory_Analysis/) — 内存分析
- [Tools/Android_Tools](../06-Foundation/Tools/Android_Tools/) — 抓取工具
...
- [Linux_Kernel/Binder](../01-Mechanism/Kernel/Binder/) — Binder
- [Linux_Kernel/FS](../01-Mechanism/Kernel/FS/) — FS（含 pstore）
...
| 轮次 | 类别 | 决策 | 理由 | 影响范围 |
|------|------|------|------|---------|
| 1 | P1 #1 图表密度 | F00-F05 各 +2 张图，F02 +4，F04 +3 | 8 篇图密度全部达到 5-7 张目标（§4 #26 达标）| 全系列 |
| 1 | P1 #3 量化自检表 | 8 篇全部追加 8-10 条量化数据 | 满足 §4 #15 量化自检（与 §6.2 工程基线合并到附录 D）| 全系列 |
