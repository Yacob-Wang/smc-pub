...
- 强依赖：[OC01-oncall 工程总论](OC01-oncall工程总论：值班机制与工具栈.md) / [02-Symptom/S06-REBOOT](../../04-卷4-稳定性症状/42-REBOOT/01-症状机制.md) / [04-Tool/Watchdog 系列](../../04-Tool/Watchdog/) 9 篇
...
| 模块 | 路径 | 关键 |
|:-----|:-----|:-----|
| REBOOT 机制 | [../04-卷4-稳定性症状/42-REBOOT/01-症状机制.md](../../04-卷4-稳定性症状/42-REBOOT/01-症状机制.md) | 4 类 |
| Watchdog | [OC05-SWT 响应剧本](OC05-SWT响应剧本.md) | 4 层 |
| pstore | [Kernel/01-Mechanism/Kernel/Partition/05-动态分区与super容器](../../01-卷1-平台基础与启动/02-AOSP%20源码结构与构建系统/2.B-分区架构演进/05-动态分区与super容器.md) | pstore |
| dropbox | [Dumpsys/11-稳定性监控集成](../../../03-卷3-调查工具/24-Dumpsys · Bugreport · DropBox/11-稳定性监控集成.md) | dropbox |
