...
| 章节 | 标题 | 行数目标 | 状态 |
| :--- | :--- | ---: | :---: |
| 01 | [ART 总览：稳定性架构师的全局视角](20.A-ART基础/01-ART总览：稳定性架构师的全局视角.md) | ~700 | ✅ |
...
| 引用系列 | 引用主题 |
| :--- | :--- |
| [Linux_Kernel/Process](../01-Mechanism/Kernel/Process/) | 进程 / fork / 信号 |
| [Linux_Kernel/Memory_Management](../01-Mechanism/Kernel/Memory_Management/) | 虚拟内存 / VMA |
| [Linux_Kernel/FS](../01-Mechanism/Kernel/FS/) | mmap / Dex / OAT 加载 |
| [Linux_Kernel/Binder](../01-Mechanism/Kernel/Binder/) | ART Service 通信 |
| [Android_Framework/AMS](../../Android_Framework/AMS/) | ANR 检测 |
| [Runtime/Native_Crash](../01-Mechanism/Runtime/Native_Crash/) | Native 信号 / Tombstone |
