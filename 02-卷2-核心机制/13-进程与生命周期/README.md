...
本系列 3 篇（A02 / A04 / A05）图表密度 < 3 张（实际各 2 张），**接受为 §8 破例**——理由是这些文章以"源码/路径对账"为主，**表格信息密度更高**（60-130 表格行/篇）。破例仅本系列 3 篇，不传染。决策记录见 [Reference/版本基线.md §二](../../00-Meta/版本基线.md) 2026-07-18 行。
