...
| **Zygote fork** | [Android_Framework/Process 03](../13.B-进程生命周期/03-Zygote-Android进程工厂.md) | Zygote 的进程工厂角色;fork 的实现细节 |
...
| **Resources 加载** | [Android_Framework/Process 04](../13.B-进程生命周期/04-应用进程首生-fork到ActivityThread.md) | 应用首生时 AssetManager 创建;resources.arsc 解析 |
