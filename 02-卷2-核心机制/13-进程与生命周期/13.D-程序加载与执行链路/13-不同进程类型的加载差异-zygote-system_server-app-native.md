...
- **不重复内容**:
  ...
  - **AMS 调度策略** → 详见 [Android_Framework/Process/02-AMS](../13.B-进程生命周期/02-AMS-冷启动判定与进程启动链路.md)
  - **lmkd 杀进程策略** → 详见 [Android_Framework/Process/06-Kernel进程接口](../13.B-进程生命周期/06-Framework视角的Kernel进程接口_procfs_cgroup_pidfd.md)
