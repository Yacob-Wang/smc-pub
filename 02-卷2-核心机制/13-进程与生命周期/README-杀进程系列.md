...
### [01-杀进程全链路：从 AMS 触发到进程完全退出](13.B-进程生命周期/01-杀进程全链路：从AMS触发到进程完全退出.md)
...
### [02-do_exit 内部 9 个 sub-step 深潜](13.B-进程生命周期/02-do_exit内部9个sub-step深潜.md)
...
### [03-杀进程慢的真正根因：诱因、根因、证伪](13.B-进程生命周期/03-杀进程慢的真正根因：诱因-根因-证伪.md)
...
### [04-杀进程监控与治理：ftrace / Perfetto / 告警 / 治理](13.B-进程生命周期/04-杀进程监控与治理：ftrace-perfetto-告警-治理.md)
...
### [Process 09-杀进程慢的根因定位实战](13.B-进程生命周期/09-杀进程慢的根因定位实战.md)
...
- [x] **Step 0**：系列 README + 4 篇架构设计 — 2026-07-20
- [x] **Step 1**：01 骨架（让你过架构）— 2026-07-20
- [x] **Step 2**：01 完整内容（按 v5 规范重写，701 行）— 2026-07-20
- [x] **Step 3**：02 do_exit 9 sub-step 源码深潜（689 行）— 2026-07-21
- [x] **Step 4**：03 真正根因：诱因/根因/证伪（567 行）— 2026-07-21
- [x] **Step 5**：04 监控 + 告警 + 治理（657 行）— 2026-07-21
- [ ] **Step 6**：Process 09 实战重写（基于新理论框架，可选）

**总进度：4/4 = 100%（4 篇理论全部完成）**
...
- **往前**：[Process 系列 README](README-进程架构演进系列.md)
- **往后**：本系列 02/03/04 篇（待写）
- **实战**：[Process 09 杀进程慢的根因定位实战](13.B-进程生命周期/09-杀进程慢的根因定位实战.md)
