...
本系列 3 篇（B05 / B06 / B07）图表密度 < 3 张（实际各 1-2 张），**接受为 §8 破例**——理由是 Sticky 演进 / LocalBroadcast 替代 / 后台限制主题以"路径对账 + 演进表"为主，**表格信息密度更高**。破例仅本系列 3 篇，不传染。决策记录见 [Reference/版本基线.md §二](../../../00-Meta/版本基线.md) 2026-07-18 行。
