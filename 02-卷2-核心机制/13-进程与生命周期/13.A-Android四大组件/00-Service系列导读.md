...
本系列 2 篇（S05 / S09）图表密度 < 3 张（实际各 1-2 张），**接受为 §8 破例**——理由是 WorkManager 演进和 Binder 限制主题以"路径对账"为主，**表格信息密度更高**。破例仅本系列 2 篇，不传染。决策记录见 [Reference/版本基线.md §二](../../../00-Meta/版本基线.md) 2026-07-18 行。
