...
> 跨系列引用：四大组件协作图全景见 [Service 全景](01_Service_Overview.md) §2.1 / [Broadcast 全景](B01_Broadcast_Overview.md) §2.1 / [ContentProvider 全景](C01_ContentProvider_Overview.md) §2.1（四大组件协作图）。
