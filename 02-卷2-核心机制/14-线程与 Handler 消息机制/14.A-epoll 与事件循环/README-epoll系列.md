...
- **主线程假死**：主线程在 epoll_wait 唤醒后做了同步 IO（详见 [Handler 系列](../README-Handler系列.md)）
...
**这是本系列与 [socket 系列](../../17-网络与连接/README-Socket系列.md) 的核心关系，必须先讲清楚：**
...
- 本系列强依赖 [socket 04-缓冲区与数据收发](../../17-网络与连接/04-Socket缓冲区与数据收发.md) §4（阻塞与非阻塞）
...
- [socket 01-Socket总览](../../17-网络与连接/01-Socket总览.md) §2.2（struct socket ↔ struct sock ↔ struct file）也对理解本系列有帮助
...
- 理解 socket 端点视角：[socket 01-Socket总览](../../17-网络与连接/01-Socket总览.md)
- 理解 socket 阻塞与 epoll 的对接：[socket 04-缓冲区与数据收发](../../17-网络与连接/04-Socket缓冲区与数据收发.md) §4
- 理解 wait queue 与 D 状态：[IO 07-IO 与进程阻塞](../../IO/07-IO与进程阻塞.md)
- 理解 epoll 与 socket 的协作原理：[socket/bridge/01-socket与epoll的关系](../../17-网络与连接/01-socket与epoll的关系.md)
- 理解 InputDispatcher 端到端：[Input 系列](../01-Mechanism/Framework/Input/)
- 理解主线程消息机制：[Handler 系列](../README-Handler系列.md)
...
| §3 架构与交互 | socket | [socket 01-Socket总览](../../17-网络与连接/01-Socket总览.md) §2 | socket 的 VFS 绑定层 |
...
| §7 Looper | Handler | [Handler 系列](../README-Handler系列.md) | Java/Native Looper 关系 |
| §7 Java NIO Selector | socket | [socket 06-UDS 与 Android](../../17-网络与连接/06-Unix_Domain_Socket与Android使用.md) | Java NIO 与 UDS |
| §9 实战案例 | socket | [socket 04-缓冲区与数据收发](../../17-网络与连接/04-Socket缓冲区与数据收发.md) | 缓冲区与 ANR 关联 |
