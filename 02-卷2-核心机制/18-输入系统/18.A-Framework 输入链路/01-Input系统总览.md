...
- **强依赖**:
  - [Socket 01-Socket 总览](../../17-网络与连接/01-Socket总览.md)(UDS socketpair 是 InputChannel 底层,本篇会涉及)
  - [IO 06-IO 与进程](../../02-卷2-核心机制/16-IO 与存储/06-IO与进程的深度耦合：D状态、iowait、IO-hang、进程阻塞.md)(D 状态 + ANR 判定)
