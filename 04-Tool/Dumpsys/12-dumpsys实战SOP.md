...
| 2 | 硬伤 | 12 P0 剧本 × 完整 dumpsys 链路 | §4 #8 案例可验证性 | §3 |
| 3 | 锐度 | 删"建议""通常" | 反例 #5 | 全文 |
| 2026-07-18 实际校准 | 结构 | 12 篇全部补上"写作标准"段 | 本规范要求 9 项硬指标 | D01-D12 |
...
| 2026-07-18 实际校准 | 反例 | 12 篇无代码堆砌 / 无 AI 自嗨 / 无路径幻觉 / 无版本混用 / 无跨篇重复 | §4 12 反例清单 | 12 篇 |
...
- **稳定性机制联动**：[Stability S00-S07](../02-Symptom/S00-稳定性症状总览.md)
