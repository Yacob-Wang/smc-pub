...
|----------|---------|---------|---------|
| [01 §4 数据源] | Kernel_Tools | [ftrace 语法解析](../../05-卷5-调查方法论与工具链/35-断点与 Native 调试/ftrace的语法解析.md) | 数据源底层就是 ftrace |
...
| [03 §3 statsd 触发器] | Tools | [Trace 抓取方法全面指南](../../05-卷5-调查方法论与工具链/35-断点与 Native 调试/20-Trace抓取方法全面指南：ftrace-atrace-systrace-perfetto.md) | 与 atrace / systrace 的能力对比 |
...
| [ftrace 的语法解析](../../05-卷5-调查方法论与工具链/35-断点与 Native 调试/ftrace的语法解析.md) | ftrace 语法本身 | [02 §3] 引用其语法规则,本系列只讲 Perfetto 怎么读 ftrace |
...
| [Android 设备如何抓取 trace](../../05-卷5-调查方法论与工具链/35-断点与 Native 调试/Android设备如何抓取trace.md) | 设备操作基础 | 不重复,本系列默认读者会抓 trace |
