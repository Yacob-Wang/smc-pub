...
> - 命令行参数细节(见 [Tools/Tracing/20-Trace抓取方法全面指南](../../05-卷5-调查方法论与工具链/35-断点与 Native 调试/20-Trace抓取方法全面指南：ftrace-atrace-systrace-perfetto.md))
> - ftrace 语法本身(见 [Tools/Tracing/ftrace 的语法解析](../../05-卷5-调查方法论与工具链/35-断点与 Native 调试/ftrace的语法解析.md))
