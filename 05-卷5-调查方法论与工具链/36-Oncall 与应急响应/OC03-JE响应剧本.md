...
- 强依赖：[OC01](OC01-oncall工程总论：值班机制与工具栈.md) / [S02-JE](../../../04-卷4-稳定性症状诊断/23-Java 异常/01-症状机制.md) / [F03-JE](../F03-JE/01-取证机制.md) / [Dumpsys](../../04-Tool/Dumpsys/)
...
| 轮次 | 决策 | 理由 |
|:-----|:-----|:-----|
| 1 | 单篇 500+ 行（§8 破例）| 5 类异常 + 3 场景 |
| 2 | 黄金 5/15/30 每分钟给动作 | 反例 #4 |
| 3 | 删"可能"，改"必做" | 反例 #5 |
...
| 模块 | 路径 | 关键类/方法 |
|:-----|:-----|:-------------|
| JE 机制 | [../04-卷4-稳定性症状诊断/23-Java 异常/01-症状机制.md](../../../04-卷4-稳定性症状诊断/23-Java 异常/01-症状机制.md) | UncaughtExceptionHandler |
| JE 取证 | [../04-卷4-稳定性症状诊断/23-Java 异常/01-取证机制.md](../F03-JE/01-取证机制.md) | 完整流程 |
| dumpsys | [04-Tool/Dumpsys/01-dumpsys总览与架构](../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/01-dumpsys总览与架构.md) | dumpsys |
| 内存分析 | [04-Tool/Dumpsys/04-内存分析](../../../05-卷5-调查方法论与工具链/33-Dumpsys · Bugreport · DropBox/04-内存分析.md) | meminfo |
