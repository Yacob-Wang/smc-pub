...
- 强依赖：[OC01-oncall 工程总论](OC01-oncall工程总论：值班机制与工具栈.md) / [02-Symptom/S05-HANG](../../../04-卷4-稳定性症状诊断/26-HANG 与死锁/01-症状机制.md) / [03-Forensics/F06-HANG-OOM](../F06-HANG-OOM/01-取证机制.md) / [04-Tool/Hprof](../../04-Tool/Hprof/) 5 篇
...
| 模块 | 路径 | 关键 |
|:-----|:-----|:-----|
| HANG 机制 | [../04-卷4-稳定性症状诊断/26-HANG 与死锁/01-症状机制.md](../../../04-卷4-稳定性症状诊断/26-HANG 与死锁/01-症状机制.md) | 3 类 |
| HANG/OOM 取证 | [../04-卷4-稳定性症状诊断/26-HANG 与死锁/01-取证机制.md](../F06-HANG-OOM/01-取证机制.md) | 完整流程 |
| Hprof | [04-Tool/Hprof/04-内存泄漏典型案例与排查SOP](../../../05-卷5-调查方法论与工具链/34-Hprof 与内存分析/04-内存泄漏典型案例与排查SOP.md) | 案例 |
