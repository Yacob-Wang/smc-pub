...
- 强依赖：[OC01](OC01-oncall工程总论：值班机制与工具栈.md) / [S01-ANR](../../../04-卷4-稳定性症状诊断/22-ANR 深度/01-症状机制.md) / [F01-ANR](../F01-ANR/01-取证机制.md) / [ANR-Detection](../../04-Tool/ANR-Detection/)
...
| 轮次 | 决策 | 理由 |
|:-----|:-----|:-----|
| 1 | 单篇 500+ 行（§8 破例）| 3 类 ANR × 完整剧本 |
| 2 | 黄金 5/15/30 每分钟给具体动作 | 反例 #4 |
| 3 | 删"可能"，改"必做" | 反例 #5 |
...
详见 [../04-卷4-稳定性症状诊断/22-ANR 深度/Input_Dispatch_Timeout_ANR_Deep_Dive.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/Input_Dispatch_Timeout_ANR_Deep_Dive.md)。
...
详见 [../04-卷4-稳定性症状诊断/22-ANR 深度/Service_ANR_Deep_Dive.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/Service_ANR_Deep_Dive.md)。
...
详见 [../04-卷4-稳定性症状诊断/22-ANR 深度/01-症状机制.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/01-症状机制.md) §3。
...
| 模块 | 路径 | 关键类/方法 |
|:-----|:-----|:-------------|
| ANR 机制 | [../04-卷4-稳定性症状诊断/22-ANR 深度/01-症状机制.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/01-症状机制.md) | 4 类触发 |
| ANR 取证 | [../04-卷4-稳定性症状诊断/22-ANR 深度/01-取证机制.md](../F01-ANR/01-取证机制.md) | 完整流程 |
| Input ANR 深潜 | [../04-卷4-稳定性症状诊断/22-ANR 深度/Input_Dispatch_Timeout_ANR_Deep_Dive.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/Input_Dispatch_Timeout_ANR_Deep_Dive.md) | Input 5s |
| Service ANR 深潜 | [../04-卷4-稳定性症状诊断/22-ANR 深度/Service_ANR_Deep_Dive.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/Service_ANR_Deep_Dive.md) | Service 20s |
| NoFocusWindow ANR | [../04-卷4-稳定性症状诊断/22-ANR 深度/No_Focus_Window_ANR_Deep_Dive.md](../../../04-卷4-稳定性症状诊断/22-ANR 深度/No_Focus_Window_ANR_Deep_Dive.md) | 焦点窗口 |
